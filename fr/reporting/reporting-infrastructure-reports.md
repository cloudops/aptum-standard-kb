...
Pour les utilisateurs du service Aptum IaaS, le système fournit deux rapports propres à ce service :

- **Entités d'infrastructure**

Ce rapport énumère toutes les entités de la connexion au service Aptum IaaS sélectionnée. Choisissez parmi les adresses IP publiques, les instances ou les instances physiques. Le rapport fournit des renseignements de base sur chaque entité.
