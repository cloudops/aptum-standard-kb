---
title: "Aptum IaaS: Forcer l'arrêt d'une instance"
slug: aptum-iaas-forcer-le-redemarrage-d-une-instance
---
...
Si une instance ne répond plus, utilisez ces étapes pour forcer l'arrêt de l'instance :
   ...
   - Configurer l'environnement CloudMonkey : [procédure](../aptum-iaas-compute-service/aptum-iaas-install-and-config-cloudmonkey.md)
