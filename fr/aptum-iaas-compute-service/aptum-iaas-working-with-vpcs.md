---
title: "Aptum IaaS: Gestion des VPCs"
slug: aptum-iaas-gestion-des-vpcs
---
...
![Onglet de réseautique](img/working-with-vpcs-1-fr.png)
1. Complétez le formulaire d'ajouter un VPC :
   ...
   - **Domaine du réseau :** (Facultatif) Nom de domaine pour la résolution DNS interne (ex: *interne.acme.com*). Aptum IaaS ajoutera ce nom de domaine au fichier */etc/hosts* pour les futures instances.
   - **Offre de VPC :** Choisissez le niveau de service pour ce VPC.
   ![Page ajouter VPC](img/working-with-vpcs-2-fr.png)
...
![Onglet de réseautique avec VPC](img/working-with-vpcs-3-fr.png)
...
![Page de détails du VPC](img/working-with-vpcs-4-fr.png)
