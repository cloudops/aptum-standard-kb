...
9\. Cliquer sur *Browse…* et sélectionner le certificat que vous avez enregistré avec l'extension **.crt** (le certificat est disponible dans l'interface de Aptum IaaS, sur la page dédiée à la configuration du VPN d'accès distant) puis cliquer sur *Next*.
