---
title: "Aptum IaaS: Installer et configurer CloudMonkey"
slug:  aptum-iaas-installer-et-configurer-cloudmonkey
---


Apache CloudMonkey est une interface de ligne de commande (*CLI*, en anglais) écrite en Python pour interagir avec les API Aptum IaaS.

Cet fonction est utile pour automatiser l'infrastructure virtuelle dans Aptum IaaS ou la gérer via la CLI. Apache CloudMonkey peut être installé sur divers systèmes d'exploitation tels que Linux et macOS, il ne nécessite que Python 2.7+ pour être installé.
...
### Se connecter au service Aptum IaaS

Lancez la CLI avec la commande `cloudmonkey`, puis utilisez la commande CLI `sync` pour confirmer que CloudMonkey est connecté à l'API Aptum IaaS.
