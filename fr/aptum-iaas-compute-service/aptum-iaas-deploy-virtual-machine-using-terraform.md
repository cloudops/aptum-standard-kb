---
title: "Aptum IaaS: Déployer une machine virtuelle à l'aide de Terraform"
slug: aptum-iaas-deployer-une-machine-virtuelle-a-l-aide-de-terraform
---
...
Un exemple simple présenté ici est l'utilisation de Terraform pour créer des instances basées sur la plate-forme Aptum IaaS à l'aide de ressources de calcul de taille personnalisées.

### Prérequis

- [Terraform](https://www.terraform.io/downloads.html) doit être installé localement
- Le [provider de Terraform pour Aptum IaaS](https://github.com/hypertec-cloud/terraform-provider-hci) doit être installé
- Une clé d'API pour Aptum IaaS valide
    - Vous pouvez générer une clé d'API pour votre compte Aptum IaaS en vous connectant à Aptum IaaS, en allant dans *Mon profil* (dans le menu **Utilisateur** en haut à droite de la page), et en cliquant sur *Identifiants d'API* dans la barre latérale.
...
Se référer à la [documentation du provider de Terraform pour Aptum IaaS](https://github.com/hypertec-cloud/terraform-provider-hci/tree/master/docs) pour les derniers attributs.
...
- [Le provider de Terraform pour Aptum IaaS](https://github.com/hypertec-cloud/terraform-provider-hci)
