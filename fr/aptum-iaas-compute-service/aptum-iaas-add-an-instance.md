---
title: "Aptum IaaS: Ajouter une instance"
slug: aptum-iaas-ajouter-une-instance
---


## À propos de cette tâche

Cet article vous guidera tout au long du processus d'ajout d'une nouvelle instance à un environnement Aptum IaaS. L'interface fournit un assistant en plusieurs étapes pour sélectionner une configuration, et l'instance \(ou les instances\) sera créée après la dernière étape de l'assistant.
