---
title: "Aptum IaaS: Gestion des modèles"
slug: aptum-iaas-gestion-des-modeles
---


### Créer un modèle à partir d'une instance existante

Cette section présente comment créer un **modèle** à partir d'une instance existante en production sur Aptum IaaS. Ce processus requiert d'abord qu'une [copie instantanée](working-with-snapshots.md) du volume soit effectuée.
...
![Liste de volumes](img/working-with-instance-templates-en-1.png)
...
![Prendre une copie instantanée](img/working-with-instance-templates-en-2.png)
...
![Liste de copies instantanées](img/working-with-instance-templates-en-4.png)
...
![Créer un modèle](img/working-with-instance-templates-en-5.png)
...
Aptum IaaS offre la possibilité aux usagers d'importer leurs propres modèles créés à l'extérieur de la plateforme. Ce processus est décrit dans cette section.
...
- **URL :** Vous ne téléverser pas des modèles vers Aptum IaaS, le système va le télécharger pour vous. Dans cette optique, vous devez fournir un **URL accessible publiquement** vers votre VHD en utilisant soit **HTTP** ou **FTP**. **Notez:** HTTPS ne fonctionnera pas.
...
| Système d'exploitation du modèle | Système d'exploitation pour Aptum IaaS |
| --- | --- |
| CentOS 7.x | CentOS 7 |
| CentOS 8.x | CentOS 7 |
