...
![Acquérir adresse IP](img/config-port-fwd-1-en.png)
...
![Adresse acquise](img/config-port-fwd-2-en.png)
1. L'écran **Règles de redirection de port** s'affiche. Cliquez sur *Ajouter une règle de redirection de port* :
![Règles de redirection de port](img/config-port-fwd-3-en.png)
...
![Ajouter une règle de redirection de port](img/config-port-fwd-4-en.png)
1. Cliquez sur *Valider*. L'écran **Règles de redirection de port** apparaîtra et la nouvelle règle sera répertoriée :
![Règle de redirection de port ajoutée](img/config-port-fwd-5-en.png)
