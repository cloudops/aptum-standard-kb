---
title: "Aptum IaaS: Créer un VPN site-à-site pour un VPC"
slug: aptum-iaas-creer-vpn-site-a-site-pour-un-vpc
---


Un VPN site-à-site est utile pour interconnecter un VPC à un bureau à distance, à un autre centre de données, ou à un autre VPC.  Pour plus de détails, consultez [Gestion des VPCs](../aptum-iaas-compute-service/working-with-vpcs.md).
