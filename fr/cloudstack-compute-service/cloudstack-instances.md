...
![Une capture d'écran de la page CloudStack Instances, avec des points numérotés indiquant les fonctionnalités intéressantes](img/cloudstack-instances-numdot.png)
