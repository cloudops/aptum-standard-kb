...
![Screenshot of an environment dashboard page, with numbered dots highlighting features of interest](img/environments-dashboard-numdot.png)
...
![Screenshot of the environments menu](img/environments-menu.png)
