---
title: "Aptum IaaS: Force shutdown an instance"
slug: aptum-iaas-force-reboot-an-instance
---
...
If an instance is becoming unresponsive, use those steps to force shutdown instance :
   ...
   - Configure CloudMonkey environment: [procedure](aptum-iaas-compute-service/aptum-iaas-install-and-config-cloudmonkey.md)
