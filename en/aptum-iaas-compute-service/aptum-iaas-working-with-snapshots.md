---
title: "Aptum IaaS: Working with snapshots"
slug: aptum-iaas-working-with-snapshots
---


A volume in Aptum IaaS can be used to create a **snapshot**, which is a static copy of that disk and all of its contents at the time the snapshot was taken.  This can be useful in several scenarios:
   ...
   - Golden image: An instance can be configured to a desired state, and a snapshot can be used to provision an [instance template](aptum-iaas-working-with-instance-templates.md) to be used for deploying multiple instances.
...
1. You can choose to provide a name for the snapshot, or if the field is left blank Aptum IaaS will automatically generate a name.
