---
title: "Aptum IaaS: Deploy a virtual machine using Terraform"
slug: aptum-iaas-deploy-virtual-machine-using-terraform
---
...
One simple example shown here is using Terraform to create instances using custom-sized compute resources.

### Prerequisites

- [Terraform](https://www.terraform.io/downloads.html) must be installed locally
- The [Terraform provider](https://github.com/hypertec-cloud/terraform-provider-hci) must be installed
- A valid Cloud API key
...
Refer to the [Terraform provider documentation](https://github.com/hypertec-cloud/terraform-provider-hci/tree/master/docs) for latest attributes.
...
- [Terraform provider](https://github.com/hypertec-cloud/terraform-provider-hci)
