...
<!-- ![Add load balancer rule, basic info](img/load-balancing-4-en.png) -->
...
<!-- ![Add load balancer rule, policies](img/load-balancing-5-en.png) -->
1. Click *Submit*.  The *Load balancer rules* page will appear, and the new load balancer rulle will be listed:
<!-- ![Load balancer rule created](img/load-balancing-6-en.png) -->
...
<!-- ![List of public IP addresses](img/load-balancing-7-en.png) -->
