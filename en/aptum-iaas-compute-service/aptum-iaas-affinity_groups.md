---
title: "Aptum IaaS: Affinity groups"
slug: aptum-iaas-affinity-groups
---


## Summary

This article introduces the concept of Aptum IaaS affinity groups, and the use cases for the different types of groups.
...
Affinity groups are listed and managed on the **Affinity groups** page of a Aptum IaaS environment:

![Screenshot of the Affinity groups page in a Aptum IaaS environment](img/cs-affinity-groups-en.png)
