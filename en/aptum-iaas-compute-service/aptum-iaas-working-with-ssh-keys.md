---
title: "Aptum IaaS: Working with SSH Keys"
slug: aptum-iaas-working-with-ssh-keys
---


Instead of using only password to login your instance, Aptum IaaS supports the push of SSH keys. This article covers the different prerequisites for this feature to work, and how to generate and upload a SSH key.
