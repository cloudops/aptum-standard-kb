---
title: "Aptum IaaS: Enable static NAT"
slug: aptum-iaas-enable-static-nat
---


This article will guide you through the steps of configuring static NAT for an instance in your environment.  Enabling static NAT for an instance will create a one-to-one mapping from a public IP address to that instance.  You should be familiar with [networking concepts](aptum-iaas-what-is-a-vpc.md) such as network address translation (NAT), static NAT, port forwarding, and access control lists (ACLs).  
...
- The target network should have the appropriate [network ACLs](aptum-iaas-securing-your-network.md) configured to allow desired traffic and to deny all other traffic.
