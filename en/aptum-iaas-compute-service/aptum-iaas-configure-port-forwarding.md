---
title:  "Aptum IaaS: Configure Port Forwarding"
slug:  aptum-iaas-configure-port-forwarding
---
...
![Acquire IP address](img/config-port-fwd-1-en.png)
...
![Address acquired](img/config-port-fwd-2-en.png)
1. The **Port forwarding rules** screen will appear.  Click on *Add port forwarding rule*:
![Port forwarding rules](img/config-port-fwd-3-en.png)
