---
title: "Aptum IaaS: Add an affinity group"
slug: aptum-iaas-add-an-affinity-group
---


## About this task

This article will guide you through the process of adding a new affinity group to a Aptum IaaS environment.

## Before you begin

-   Your Aptum IaaS environment must already exist
...
In this example, we will add a new affinity group to the Acme `production` Aptum IaaS environment. We will select an anti-affinity rule, then add our two instances, `acme-prod-web01` and `acme-prod-web02`.
...
8.  Click the **Submit** button.
    ...
    ![Screenshot of the Add affinity group page, filled out and ready to press the Submit button](img/cs-add-affinity-group-en.png)
