---
title: "Aptum IaaS: Instances"
slug: aptum-iaas-instances
---


Instances are a fundamental type of infrastructure provided by Aptum IaaS. This article discusses the concept of instances and how they are managed in the platform.

Instances are listed under the **Instances** section of the selected Aptum IaaS environment.

## Overview

Similar to other cloud platforms, Aptum IaaS provides you with the capability to run instances. Once an instance is provisioned, it can be used to execute the various components of your applications.
...
![Screenshot of the Add Instance page with the cost estimator displayed](img/cloudstack-add-an-instance.png)

## Instance list

Instances are listed under the **Instances** section of the selected Aptum IaaS environment.

![A screenshot of the Aptum IaaS Instances page, with numbered dots indicating features of interest](img/cloudstack-instances-numdot.png)

1.  **List of Aptum IaaS instances**

    A list of all instances in the selected Aptum IaaS environment appears here in this area.
