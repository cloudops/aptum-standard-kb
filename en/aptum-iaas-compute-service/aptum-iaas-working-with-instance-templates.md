...
This section will show how to create an **instance template** from an existing instance running on Aptum IaaS. This process requires a [volume snapshot](aptum-iaas-working-with-snapshots.md) to be created.
