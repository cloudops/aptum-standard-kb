---
title: "Aptum IaaS: Working with VPCs"
slug: aptum-iaas-working-with-vpcs
---
...
![Networking tab](img/working-with-vpcs-1-en.png)
1. Fill the Add VPC form:
   ...
   - **Network Domain:** (Optional) Domain name for internal DNS resolution (ex: *internal.acme.com*).  Aptum IaaS will add this domain name to the */etc/hosts* file for new instances.
   - **VPC offering:** Choose the Service Level of this VPC.
   ![Add VPC page](img/working-with-vpcs-2-en.png)
1. Click on **Submit**.
...
![Networking tab with VPC](img/working-with-vpcs-3-en.png)
...
![VPC details page](img/working-with-vpcs-4-en.png)
