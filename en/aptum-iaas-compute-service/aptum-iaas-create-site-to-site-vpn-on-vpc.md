---
title: "Aptum IaaS: Create a site-to-site VPN on a VPC"
slug: aptum-iaas-create-site-to-site-vpn-on-vpc
---


A site-to-site VPN is useful for interconnecting a VPC to a remote office, another data centre, or to another VPC.  For more details, see [Working with VPCs](aptum-iaas-compute-service/working-with-vpcs.md).
