...
![A screenshot of the Organization Usage Report](img/reporting-organization-usage.png)
...
![Screenshot of the filters available for the Organization Usage report, with the Where and What? tab selected](img/reporting-organization-usage-filters.png)
...
![Screenshot of the selector to hide and show product categories in the report](img/reporting-organization-usage-categories.png)
...
![Commitment usage](img/reporting-organization-usage-commitment.png)
...
![Utility usage](img/reporting-organization-usage-utility.png)
