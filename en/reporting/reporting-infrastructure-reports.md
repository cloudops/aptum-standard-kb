...
For users of the Aptum IaaS service, the system provides two reports specific to this service:

-   **Infrastructure Entities**

    This report lists all entities in the selected Aptum IaaS service connection. Select from public IPs, bare-metal machines, or instances. The report provides basic details for each entity.
