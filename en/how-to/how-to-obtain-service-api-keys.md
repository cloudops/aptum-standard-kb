...
Some services allow direct connection to their API using your Aptum Portal service API keys.  To get your service API keys, navigate to the user menu on the upper right of the page, click on **API credentials**, then scroll down to the section titled *Service API keys*.  Click in the search box and select the desired service.  The service API keys for the selected service will then appear below.

![Service API keys](img/api-service-keys-en-1.png)
...
![OpenStack parameters](img/api-service-keys-en-2.png)
...
![OpenStack S3 API key](img/api-service-keys-en-3.png)
...
![OpenStack parameters](img/api-service-keys-en-4.png)
