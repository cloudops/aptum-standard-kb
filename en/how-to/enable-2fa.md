...
1.  Click on the **User menu** \> **My profile** \> **Security**. The User menu is in the upper right corner of the Aptum Portal menu bar.
...
-   Two-factor authentication is now enabled on your Aptum Portal account
