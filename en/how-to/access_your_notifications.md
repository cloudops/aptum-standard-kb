...
This article describes notifications and how to access and manage them in Aptum Portal.
...
![A screenshot of an expanded Notifications panel with a notification indication progress of an operation](img/announcements-notificationpanel-en.png)
...
-   **Splash announcement**: These will appear in the center of the Aptum Portal interface, similar to a dialog box, and are normally about urgent topics that need your immediate attention
