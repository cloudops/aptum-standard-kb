---
title: "Aptum IaaS: Agregar una instancia"
slug: aptum-iaas-agregar-una-instancia
---


## Acerca de esta tarea

Este artículo te guiará a través del proceso de agregar una nueva instancia a un entorno de Aptum IaaS. La interfaz proporciona un asistente de varios pasos para seleccionar una configuración, y la instancia (o instancias) se crearán después del paso final del asistente.
