---
title: "Aptum IaaS: Agregar un grupo de afinidad"
slug: aptum-iaas-agregar-un-grupo-de-afinidad
---


## Acerca de esta tarea

Este artículo te guiará a través del proceso de agregar un nuevo grupo de afinidad a un entorno de Aptum IaaS.

## Antes de comenzar

- Tu entorno Aptum IaaS ya debe existir
...
En este ejemplo, agregaremos un nuevo grupo de afinidad al entorno de Aptum IaaS de `producción` de Acme. Seleccionaremos una regla anti-afinidad, luego agregaremos nuestras dos instancias, `acme-prod-web01` y `acme-prod-web02`.
