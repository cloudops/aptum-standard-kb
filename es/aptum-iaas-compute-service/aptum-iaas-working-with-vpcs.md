---
title: "Aptum IaaS: Gestion de VPC"
slug: aptum-iaas-gestion-de-vpc
---
...
1. Completz el formulario **Agregar VPC**:
    ...
    - **Dominio de red:** (Opcional) Nombre de dominio para resolución DNS interna (por ejemplo: *internal.acme.com*). Aptum IaaS agregará este nombre de dominio al archivo */etc/hosts* para nuevas instancias.
