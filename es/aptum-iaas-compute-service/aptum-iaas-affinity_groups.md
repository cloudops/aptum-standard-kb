---
title: "Aptum IaaS: Grupos de afinidad"
slug: aptum-iaas-grupos-de-afinidad
---


## Resumen

Este artículo presenta el concepto de grupos de afinidad de Aptum IaaS y los casos de uso para los diferentes tipos de grupos.
...
Los grupos de afinidad se enumeran y administran en la página **Grupos de afinidad** de un entorno de Aptum IaaS:

![Captura de pantalla de la página de grupos de afinidad en un entorno Aptum IaaS](img/cs-affinity-groups-en.png)
