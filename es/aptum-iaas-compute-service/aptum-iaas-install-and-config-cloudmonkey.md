---
title: "Aptum IaaS: Instalar y configurar CloudMonkey"
slug:  aptum-iaas-instalar-y-configurar-cloudmonkey
---


Apache CloudMonkey es una interfaz de línea de comandos (*CLI*, en inglés) escrita en Python para interactuar con las API de Aptum IaaS.

Esta herramienta es útil para automatizar la infraestructura virtual en Aptum IaaS o administrarla a través de la CLI. Apache CloudMonkey se puede instalar en varios sistemas operativos, como Linux y macOS, solo requiere la instalación de Python 2.7+.
...
### Conectarse al servicio Aptum IaaS

Inicia la CLI con el comando `cloudmonkey`, luego usa el comando CLI `sync` para confirmar que CloudMonkey está conectado a la API de Aptum IaaS.
