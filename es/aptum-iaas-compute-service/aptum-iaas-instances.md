---
title: "Aptum IaaS: Instancias"
slug: aptum-iaas-instancias
---


Las instancias son un tipo fundamental de infraestructura que ofrece Aptum IaaS. En este artículo, se analiza el concepto de instancias y cómo se administran en la plataforma.

Las instancias se enumeran en la sección **Instancias** del entorno Aptum IaaS seleccionado.

## Resumen

De manera similar a otras plataformas en la nube, Aptum IaaS te brinda la capacidad de ejecutar instancias. Una vez que se aprovisiona una instancia, se puede usar para ejecutar los diversos componentes de tus aplicaciones.
...
![Captura de pantalla de la página Agregar instancia con el estimador de costos mostrado](img/aptum-iaas-add-an-instance.png)

## Lista de instancias

Las instancias se enumeran en la sección **Instancias** del entorno Aptum IaaS seleccionado.

![Una captura de pantalla de la página de instancias de Aptum IaaS, con puntos numerados que indican características de interés](img/aptum-iaas-instances-numdot.png)

1. **Lista de instancias de Aptum IaaS**

Aquí, en esta área, aparece una lista de todas las instancias del entorno Aptum IaaS seleccionado.
