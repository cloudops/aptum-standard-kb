...
Para los usuarios del servicio Aptum IaaS, el sistema proporciona dos informes específicos para este servicio:

- **Entidades de infraestructura**

Este informe enumera todas las entidades en la conexión de servicio Aptum IaaS seleccionada. Se puede seleccionar entre IP públicas, instancias, o instancias dedicadas. El informe proporciona información básica de cada entidad.
