...
![Diagrama que ilustra cómo se relacionan las principales entidades en Aptum Portal y Cloudflare](cloudflare-dns-entities.png)
...
![Captura de pantalla de la página de entornos del servicio Cloudflare](cloudflare-env-list.png)
...
![Captura de pantalla de la pestaña Dominios de un entorno Cloudflare, con las características principales resaltadas.](cloudflare-domain-list.png)
...
![Captura de pantalla de la página de Registros DNS](cloudflare-dns-records.png)
