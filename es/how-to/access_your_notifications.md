...
Este artículo describe las notificaciones y cómo acceder a ellas y administrarlas en Aptum Portal.
...
![Una captura de pantalla de un panel de notificaciones ampliado con una notificación que indica el progreso de una operación.](img/announcements-notificationpanel-en.png)
...
Para estas situaciones, Aptum Portal creará una notificación en el panel de Notificaciones, aparecerá una insignia ámbar en el ícono de campana y la información confidencial se presentará dentro de la notificación. Puedes copiar la información de la notificación y luego borrarla para preservar la seguridad.

![Una captura de pantalla de una notificación que contiene una contraseña oculta con dispositivos para exponer la contraseña y copiarla al portapapeles.](img/announcements-credentials-en.png)

Debido a la naturaleza transitoria y sensible de las notificaciones de actividad, solo se puede acceder a ellas desde el panel de notificaciones y Aptum Portal nunca las guarda, y se pueden borrar manualmente si lo deseas haciendo clic en los botones **Borrar** o **Borrar todo**.
...
- **Anuncios splash**: Aparecerán en el centro de la interfaz de Aptum Portal, similar a un cuadro de diálogo, y normalmente tratan sobre temas urgentes que necesitan tu atención inmediata
...
![Captura de pantalla del panel de notificaciones con un anuncio periódico que indica un próximo cambio en un producto mostrado](img/announcements-regular-en.png)

Los anuncios splash no aparecen en el panel de notificaciones. En cambio, aparecen en el centro de la interfaz de Aptum Portal. Tienen un botón **Cerrar** y todas las funciones de la plataforma no estarán disponibles hasta que cierres el anuncio. Si cierras sesión y luego vuelves a iniciarla, el anuncio se mostrará nuevamente hasta que hagas clic en el botón **Cerrar**.

Una vez que se haya cerrado un anuncio de presentación, no volverá a aparecer.

![Captura de pantalla de la interfaz de usuario de Aptum Portal con un anuncio de bienvenida que indica un tiempo de indisponibilidad de emergencia para más tarde ese día.](img/announcements-splash-en.png)
